    ...
    <div className="mt-10 lg:mt-20">
      ...
      <div className="relative bg-gray-900">
        ...
        <div aria-hidden="true" className="absolute inset-0 overflow-hidden">
          <img
            src="https://risingranks.me/wp-content/uploads/2023/09/various-styles-in-mens-fashion.png"
        ...
        <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
          ...
          <p className="mt-4 text-xl text-white">
            Dive into our handpicked selection of exclusive items! Explore
            unique pieces meticulously curated for you.
          </p>
          <a
            href="/shop/featured-collection"
